...
COPY --from=build --chown=app-api:app-api /buile/src/main/resources/json/diary.json ./diary.json
COPY --from=build --chown=app-api:app-api /buile/src/main/resources/json/mbti.json ./mbti.json
